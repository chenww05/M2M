...
BodyModel::BodyModel(
    ...
    _shoulder_width_min = _img_width / 8, _shoulder_width_max = _img_width / 4;
    ...
    _neck_width_min = _img_width / 20, _neck_width_max = _img_width / 8;
    ...
    _hand_width_min = _img_width / 40, _hand_width_max = _img_width / 8;
    
    _leg_length = leg_length;
    _leg_length_min = _img_heigh / 10, _leg_length_max = _img_heigh / 2;
    
    _foot_width = foot_width;
    _foot_width_min = _img_width / 10, _foot_width_max = _img_width / 4;
    ...
    _leg_angle_min = 30.0, _leg_angle_max = 80.0;
    
    _arm_angle = arm_angle;
    _arm_angle_min = 30.0, _arm_angle_max = 80.0;
...
bool BodyModel::withinRange() {
    ...
    double left_arm_center_y = _center_y + _arm_width * cos_arm_angle / 2;
    double left_hand_center_x = left_arm_center_x - _arm_length * cos_arm_angle;
    double left_hand_center_y = left_arm_center_y + _arm_length * sin_arm_angle;
